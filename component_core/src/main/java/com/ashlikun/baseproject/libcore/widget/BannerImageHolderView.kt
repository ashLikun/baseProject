...
abstract class BannerImageHolderView : ViewPageHelperListener<BannerAdData> {
    ...
    override fun createView(context: Context, banner: BannerViewPager, data: BannerAdData, position: Int): View {
    ...
    abstract fun onItemClicklistener(item: View, position: Int, data: BannerAdData)

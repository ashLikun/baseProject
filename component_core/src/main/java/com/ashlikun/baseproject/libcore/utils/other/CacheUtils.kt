...
object CacheUtils {
    ...
    val sdDcimPath = StringNullAdapter.NULL
        get() = check(if (field.isNullOrEmpty()) {
            PathUtils.getExternalDcim() + File.separator + rootName
        } else field)
